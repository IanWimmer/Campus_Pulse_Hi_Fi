...
const Switch = ({
  ...
  return (<label className="flex items-center h-fit w-fit">
    <button onClick={() => setSwitched(!switched)} className={clsx("h-9 w-18 rounded-full border-2 border-black relative shadow-neobrutalist-sm transition-colors", switched ? "bg-primary-background" : "bg-transparent")}>
      <motion.div 
